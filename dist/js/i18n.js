...
export const TRANSLATIONS = {
  en: {
    ...
    gErr: "We could not file your access request, so you are NOT in the owner's approval queue yet. Check your connection and try again — asking the owner to approve you will not help until this succeeds.",
    gNet: "We could not reach the server to check your account. Check your connection and try again.",
    gLoop: "Google sign-in could not be completed — your browser did not carry the sign-in session back to this page. Trying Google again will do the same thing. Sign in with your email and password instead, or allow third-party cookies for this site.",
    gRetry: "🔄 Retry Access Request",
    gSent: "Access request filed. Waiting for owner approval.",
    pqT: "Pending Access Requests",
    pqE: "No pending access requests. A new sign-up appears here as soon as it reaches Firestore — if someone says they signed up and nothing is listed, their request never arrived and they need to sign in again.",
    pqR: "Requested",
    rosT: "Staff Roster",
  ...
  ar: {
    ...
    gErr: "تعذّر إرسال طلب الدخول الخاص بك، لذلك أنت غير مُدرج في قائمة موافقات المالك. تحقق من الاتصال وحاول مرة أخرى — لن تفيد مطالبة المالك بالموافقة قبل نجاح هذه الخطوة.",
    gNet: "تعذّر الوصول إلى الخادم للتحقق من حسابك. تحقق من الاتصال وحاول مرة أخرى.",
    gLoop: "تعذّر إكمال تسجيل الدخول عبر Google — لم يحتفظ متصفحك بجلسة الدخول عند العودة إلى هذه الصفحة، وإعادة المحاولة عبر Google ستعطي النتيجة نفسها. سجّل الدخول بالبريد الإلكتروني وكلمة المرور، أو اسمح بملفات تعريف الارتباط الخارجية لهذا الموقع.",
    gRetry: "🔄 إعادة إرسال طلب الدخول",
    gSent: "تم إرسال طلب الدخول. في انتظار موافقة المالك.",
    pqT: "طلبات الدخول قيد الانتظار",
    pqE: "لا توجد طلبات دخول قيد الانتظار. يظهر أي تسجيل جديد هنا فور وصوله إلى Firestore — فإذا أخبرك أحدهم أنه سجّل ولم يظهر هنا، فإن طلبه لم يصل ويجب أن يسجّل الدخول من جديد.",
    pqR: "تاريخ الطلب",
    rosT: "قائمة الطاقم",
    oM: "إدارة الحسابات",
